...
class CityAdapter(
  ...
  fun removeLandmark(landmarkToRemove: Landmark): Int {
    val databaseHandler = DatabaseHandler(context)
    val status =
  ...
  override fun onBindViewHolder(holder: CitiesViewHolder, position: Int) {
    ...
    val landmarksAdapter = LandmarksAdapter(this@CityAdapter, currentCityLandmarks)
    ...
    holder.itemView.apply {
      ...
      rvLandmarks.layoutManager = LinearLayoutManager(this.context)
